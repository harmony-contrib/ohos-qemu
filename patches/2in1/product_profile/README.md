# Full 2in1 profile component for QEMU

This component makes the standard QEMU products source-built 2in1 products. It
...
```bash
patches/2in1/product_profile/apply.sh \
