# Standard QEMU VPN component patch set

This component patch set makes OpenHarmony's standard VpnExtension capability a required
...
Apply it after the `armv7a_product` component, when that product is selected,
and before building:

```sh
bash patches/common/standard_vpn/apply.sh \
