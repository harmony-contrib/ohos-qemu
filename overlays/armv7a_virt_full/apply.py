...
def copy_owned_tree(src: Path, dst: Path) -> None:
    ...
    # Refresh an owned generated tree without rewriting unchanged files. The
    # previous remove/copy cycle changed every mtime and forced thousands of
    # unrelated armv7 targets to relink on each phone/2in1 matrix pass.
